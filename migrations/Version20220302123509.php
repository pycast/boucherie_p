 ...
 */
final class Version20220302123509 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE delivery_date delivery_date VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE reference reference VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE stripesessionid stripesessionid VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
